...
const ICON_MAP = {
  Sprout: () => (
    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 19V6m0 0C12 6 9 3 5 3c0 4 2 7 5 8m2-8c0 0 3-3 7-3 0 4-2 7-5 8" />
    </svg>
  ),
  ArrowLeftRight: () => (
    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      >
        ...
        <div className="p-8">
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <div>
              <h3 className="text-xl font-bold text-[var(--text)]" style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700 }}>
                {project.title}
              </h3>
          ...
          {/* Period */}
          <p className="text-xs text-[var(--text-muted)] mb-4" style={{ fontFamily: "'JetBrains Mono', monospace" }}>
            {project.period}
          </p>
          ...
          <div className="flex gap-3">
            {project.github && (
              <a href={project.github} target="_blank" rel="noopener noreferrer"
                ...
                style={{ background: "var(--bg)", border: "1px solid var(--border)", fontFamily: "'DM Sans', sans-serif" }}>
        ...
        {allTech.map((t) => (
          <button
            ...
            className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-all duration-200 whitespace-nowrap ${
              filter === t ? "text-[var(--text)]" : "text-[var(--text-muted)] hover:text-[var(--text)]"
            }`}
            style={{
              fontFamily: "'JetBrains Mono', monospace",
              background: filter === t ? "rgba(99,102,241,0.2)" : "var(--surface)",
              border: filter === t ? "1px solid rgba(99,102,241,0.5)" : "1px solid var(--border)",
            }}
          >
            {t}
          </button>
        ...
        {filtered.map((p) => {
          ...
          return (
            ...
            >
              ...
              {/* Title */}
              <h3 className="text-lg font-600 text-[var(--text)] mb-1" style={{ fontFamily: "'Syne', sans-serif", fontWeight: 600 }}>
                {p.title}
              </h3>
              <p className="text-sm mb-3" style={{ color: p.color, fontFamily: "'DM Sans', sans-serif" }}>
                {p.subtitle}
              </p>
              <p className="text-sm text-[var(--text-muted)] leading-relaxed mb-5 flex-1 line-clamp-3" style={{ fontFamily: "'DM Sans', sans-serif" }}>
                {p.description}
              </p>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-[var(--border)]">
                ...
                <span className="text-xs flex items-center gap-1" style={{ color: p.color, fontFamily: "'DM Sans', sans-serif" }}>
                  View details
